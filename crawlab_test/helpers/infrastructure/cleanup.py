...
def cleanup_test_processes():
    ...
    patterns = ["test_spider", "crawlab_test", "reconciliation_test"]
...
def main():
    ...
    parser.add_argument("--reconciliation-test-data", action="store_true", help="Clean up reconciliation test data")
