...
class DatabaseHelper:
    def __init__(self, connection_string: Optional[str] = None):
        self.connection_string = connection_string or os.getenv("CRAWLAB_MONGO_URI", "mongodb://localhost:27017")
    ...
    def update_task_status(self, task_id: ObjectId, status: str, error: Optional[str] = None) -> bool:
        """Update task status"""
        tasks_collection = self.get_collection("tasks")
    ...
    def get_tasks_by_node(self, node_id: ObjectId, status: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    def delete_test_tasks(self, task_ids: Optional[List[ObjectId]] = None) -> int:
    ...
    def delete_test_nodes(self, node_ids: Optional[List[ObjectId]] = None) -> int:
    ...
    def delete_test_spiders(self, spider_ids: Optional[List[ObjectId]] = None) -> int:
        """Delete test spiders"""
        spiders_collection = self.get_collection("spiders")
        if spider_ids:
    ...
    # Utility operations
    def wait_for_task_status_change(
        self, task_id: ObjectId, expected_status: str, timeout: int = 60, poll_interval: float = 1.0
    ) -> bool:
    ...
    def wait_for_task_status_not(
        self, task_id: ObjectId, unwanted_status: str, timeout: int = 60, poll_interval: float = 1.0
    ) -> bool:
