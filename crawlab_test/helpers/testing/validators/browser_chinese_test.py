...
Examples:
  ...
  python browser_chinese_test.py --info
    ...
    parser.add_argument(
        "--browser", choices=["playwright", "selenium", "both"], default="both", help="Browser automation tool to test"
    )
    parser.add_argument("--info", action="store_true", help="Display system locale information")
