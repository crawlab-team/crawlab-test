...
class DockerContainerManager:
    ...
    def reconnect_worker(self, worker_name: str, network_name: Optional[str] = None):
        ...
        self.logger.error("Could not determine network for reconnection")
        return False
...
def main():
    ...
    parser.add_argument(
        "--action",
        choices=["list", "disconnect", "reconnect", "health", "logs", "exec", "fail", "monitor"],
        required=True,
        help="Action to perform",
    )
    parser.add_argument("--container", help="Container name")
    parser.add_argument("--method", choices=["network", "pause"], default="network", help="Disconnection method")
    ...
    parser.add_argument(
        "--failure-type", choices=["pause", "restart"], default="pause", help="Type of failure to simulate"
    )
