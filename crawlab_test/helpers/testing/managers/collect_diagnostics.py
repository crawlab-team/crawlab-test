...
class DiagnosticsCollector:
    ...
    def collect_network_info(self):
        ...
        network_names = ["crawlab-test_crawlab_test", "crawlab_test", "crawlab_default"]
...
def main():
    ...
    parser.add_argument("--output-dir", type=Path, help="Output directory for diagnostics (default: results/)")
    ...
    parser.add_argument(
        "--containers", nargs="+", help="Specific containers to collect logs from (default: all known containers)"
    )

    args = parser.parse_args()

    try:
        collector = DiagnosticsCollector(output_dir=args.output_dir, namespace=args.namespace)
