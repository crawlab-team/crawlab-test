...
class CleanupHelper:
    ...
    def delete_user(self, token: str, user_id: str) -> bool:
        ...
        try:
            response = requests.delete(
                f"{self.base_url}/users/{user_id}", headers={"Authorization": f"Bearer {token}"}, timeout=10
            )
            return response.status_code == 200
        except Exception:
            return False
    ...
    def delete_token(self, token: str, token_id: str) -> bool:
        ...
        try:
            response = requests.delete(
                f"{self.base_url}/tokens/{token_id}", headers={"Authorization": f"Bearer {token}"}, timeout=10
            )
            return response.status_code == 200
        except Exception:
            return False
    ...
    def delete_database(self, token: str, database_id: str) -> bool:
        ...
        try:
            response = requests.delete(
                f"{self.base_url}/databases/{database_id}", headers={"Authorization": f"Bearer {token}"}, timeout=10
            )
            return response.status_code == 200
        except Exception:
            return False
    ...
    def delete_git(self, token: str, git_id: str) -> bool:
        ...
        try:
            response = requests.delete(
                f"{self.base_url}/gits/{git_id}", headers={"Authorization": f"Bearer {token}"}, timeout=10
            )
            return response.status_code == 200
        except Exception:
            return False
    ...
    def delete_project(self, token: str, project_id: str) -> bool:
        ...
        try:
            response = requests.delete(
                f"{self.base_url}/projects/{project_id}", headers={"Authorization": f"Bearer {token}"}, timeout=10
            )
            return response.status_code == 200
        except Exception:
            return False
