...
class APIAssertions:
    ...
    @staticmethod
    def assert_response_data(response_data: Dict, expected_type: type = dict, message: Optional[str] = None) -> Any:
        """
    ...
    def assert_spider_exists(spider_data: Dict):
        ...
        for field in required_fields:
            APIAssertions.assert_has_field(spider_data, field, f"Spider missing required field: {field}")
    ...
    def assert_task_exists(task_data: Dict):
        ...
        for field in required_fields:
            APIAssertions.assert_has_field(task_data, field, f"Task missing required field: {field}")
    ...
    def assert_user_exists(user_data: Dict):
        ...
        for field in required_fields:
            APIAssertions.assert_has_field(user_data, field, f"User missing required field: {field}")
