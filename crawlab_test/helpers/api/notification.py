...
class NotificationAPIHelper:
    ...
    def create_channel(self, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = requests.post(
                f"{self.base_url}/notifications/channels", json={"data": data}, headers=self._get_headers(), timeout=10
            )
    ...
    def get_channel(self, channel_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/notifications/channels/{channel_id}", headers=self._get_headers(), timeout=10
            )
            response.raise_for_status()
            result = response.json()
            return result.get("data")
    ...
    def create_alert(self, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = requests.post(
                f"{self.base_url}/notifications/alerts", json={"data": data}, headers=self._get_headers(), timeout=10
            )
            response.raise_for_status()
            result = response.json()
            return result.get("data")
    ...
    def get_alert(self, alert_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/notifications/alerts/{alert_id}", headers=self._get_headers(), timeout=10
            )
            response.raise_for_status()
            result = response.json()
            return result.get("data")
    ...
    def create_setting(self, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = requests.post(
                f"{self.base_url}/notifications/settings", json={"data": data}, headers=self._get_headers(), timeout=10
            )
            response.raise_for_status()
            result = response.json()
            return result.get("data")
    ...
    def get_setting(self, setting_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/notifications/settings/{setting_id}", headers=self._get_headers(), timeout=10
            )
            response.raise_for_status()
            result = response.json()
            return result.get("data")
    ...
    def enable_setting(self, setting_id: str) -> bool:
        ...
        try:
            response = requests.post(
                f"{self.base_url}/notifications/settings/{setting_id}/enable", headers=self._get_headers(), timeout=10
            )
            response.raise_for_status()
            return True
        except Exception as e:
    ...
    def disable_setting(self, setting_id: str) -> bool:
        ...
        try:
            response = requests.post(
                f"{self.base_url}/notifications/settings/{setting_id}/disable", headers=self._get_headers(), timeout=10
            )
            response.raise_for_status()
            return True
        except Exception as e:
    ...
    def create_request(self, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = requests.post(
                f"{self.base_url}/notifications/requests", json={"data": data}, headers=self._get_headers(), timeout=10
            )
            response.raise_for_status()
            result = response.json()
            return result.get("data")
    ...
    def get_request(self, request_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/notifications/requests/{request_id}", headers=self._get_headers(), timeout=10
            )
            response.raise_for_status()
            result = response.json()
            return result.get("data")
