...
def run_sys_001_test(container_name: str = "master", verbose: bool = False, include_browsers: bool = True) -> bool:
    """
...
def main():
    ...
    parser.add_argument("--container", default="master", help="Container name to test (default: master)")
    parser.add_argument("--verbose", "-v", action="store_true", help="Enable verbose logging")
    parser.add_argument("--spec", help="Path to test specification (for compatibility)")
    parser.add_argument("--ci", action="store_true", help="CI mode - stricter validation")
    parser.add_argument(
        "--skip-browsers", action="store_true", help="Skip browser-specific tests (Playwright/Selenium)"
    )
    ...
    try:
        success = run_sys_001_test(
            container_name=args.container, verbose=args.verbose, include_browsers=not args.skip_browsers
        )
