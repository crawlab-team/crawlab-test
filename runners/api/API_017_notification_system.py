...
from helpers.api.notification import NotificationAPIHelper
...
def run_test():
    ...
    try:
        ...
        if channel1_id:
            ...
            updated_channel = notif_helper.update_channel(channel1_id, {
        ...
        if channel1_id:
            ...
            test_result = notif_helper.test_channel(channel1_id)
        ...
        if len(channel_ids) >= 2:
            ...
            batch_updated = notif_helper.batch_update_channels(
                channel_ids[:2],
        ...
        if alert1_id:
            ...
            updated_alert = notif_helper.update_alert(alert1_id, {
        ...
        if len(alert_ids) >= 2:
            ...
            batch_updated = notif_helper.batch_update_alerts(
                alert_ids[:2],
                {"description": "Updated via batch"}
            )
        ...
        if channel1_id and alert1_id:
            ...
            if setting1:
                ...
                check(setting1.get('enabled') == True, "Setting enabled by default")
        else:
        ...
        if setting1_id:
            ...
            updated_setting = notif_helper.update_setting(setting1_id, {
        ...
        invalid_alert = notif_helper.create_alert({
            "name": "invalid_alert",
            "type": "invalid_type",
            "conditions": {}
        })
