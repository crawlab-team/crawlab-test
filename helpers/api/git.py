...
class GitHelper:
    ...
    def create_git(self, token: str, name: str, url: str, 
                   auth_type: Optional[str] = None,
                   username: Optional[str] = None,
                   password: Optional[str] = None,
                   **kwargs) -> Tuple[Optional[str], Optional[Dict]]:
        """
    ...
    def list_gits(self, token: str, page: int = 1, size: int = 10,
                  conditions: Optional[str] = None) -> Optional[Dict]:
        """
    ...
    def checkout_git(self, token: str, git_id: str, branch: str) -> Optional[Dict]:
        ...
        try:
            ...
            response = requests.post(
                f"{self.base_url}/gits/{git_id}/checkout",
                headers=self._get_headers(token),
                json=payload,
                timeout=30
            )
    ...
    def pull_git(self, token: str, git_id: str) -> Optional[Dict]:
        ...
        try:
            response = requests.post(
                f"{self.base_url}/gits/{git_id}/pull",
                headers=self._get_headers(token),
                timeout=60
            )
    ...
    def commit_git(self, token: str, git_id: str, message: str,
                   files: Optional[List[str]] = None) -> Optional[Dict]:
        """
        ...
        try:
            ...
            response = requests.post(
                f"{self.base_url}/gits/{git_id}/commit",
                headers=self._get_headers(token),
                json=payload,
                timeout=30
            )
    ...
    def push_git(self, token: str, git_id: str) -> Optional[Dict]:
        ...
        try:
            response = requests.post(
                f"{self.base_url}/gits/{git_id}/push",
                headers=self._get_headers(token),
                timeout=60
            )
    ...
    def get_git_branches(self, token: str, git_id: str) -> Optional[Dict]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/gits/{git_id}/branches",
                headers=self._get_headers(token),
                timeout=10
            )
    ...
    def get_git_remotes(self, token: str, git_id: str) -> Optional[Dict]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/gits/{git_id}/remotes",
                headers=self._get_headers(token),
                timeout=10
            )
    ...
    def get_git_logs(self, token: str, git_id: str, page: int = 1, 
        ...
        try:
            ...
            response = requests.get(
                f"{self.base_url}/gits/{git_id}/logs",
                headers=self._get_headers(token),
                params=params,
                timeout=10
            )
