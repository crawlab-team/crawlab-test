...
class SpiderHelper:
    ...
    def create_spider(self, token: str, name: str, cmd: str = "python main.py", 
                     project_id: Optional[str] = None, **kwargs) -> Tuple[Optional[str], Optional[Dict]]:
        """
        Create a new spider.
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return None, {"error": f"Spider creation failed with status {response.status_code}", "response": response.text}
    ...
    def run_spider(self, token: str, spider_id: str, cmd: Optional[str] = None, 
                   mode: str = "random", priority: int = 5) -> Tuple[Optional[List[str]], Optional[Dict]]:
        """
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return None, {"error": f"Run spider failed with status {response.status_code}", "response": response.text}
