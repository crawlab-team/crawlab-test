...
def setup_logging(level: Union[str, int] = "INFO", log_file: str = None) -> logging.Logger:
...
def wait_with_timeout(condition_func, timeout: int = 60, 
...
def wait_for_condition(condition_func, timeout: int = 60, 
